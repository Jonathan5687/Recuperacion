...
pygame.draw.rect(menu, (235, 0, 0), pygame.Rect(0, 0, ancho_pantalla / 3, 50)) # Botón del círculo
pygame.draw.rect(menu, (0, 235, 0), pygame.Rect(ancho_pantalla / 3, 0, ancho_pantalla / 3, 50)) # Botón del rectángulo
pygame.draw.rect(menu, (0, 0, 235), pygame.Rect(2 * ancho_pantalla / 3, 0, ancho_pantalla / 3, 50)) # Botón del triángulo
